...
<html lang="zh-CN">
    <head> 
        ...
        <meta name="keywords" content="导游,私人导游,兼职导游,地陪导游,个人导游,导游网" /> 
        <meta name="description" content="联途导游网为您提供世界各地的导游服务，提供个性化导游、私人导游、地陪导游、兼职导游等，包含全国各地的旅游城市，方便您快速找到合适的导游。" /> 
        <meta http-equiv="Cache-Control" content="no-transform" /> 
        <link rel="shortcut icon" href="${pageContext.request.contextPath}/images/favicon.ico" /> 
        <link rel="canonical" href="http://www.liantu.cn/daoyou/daoyou.jsp" />
        <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/css/common.css" /> 
        <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/css/guide_index.css" /> 
                ...
                <div class="inner"> 
                    <div class="main"> 
                        ...
                        <div class="module mod-person"> 
                            <div class="hd"> 
                                <span class="title">最新导游</span> 
                                <span class="subtitle">New Guide</span> 
                            </div> 
                            <div class="bd"> 
                                <ul class="list" data-type="daoyou"> 
                                    <li class="J_blocklink"> 
                                        <div class="pic"> 
                                            <a href="/daoyou/65537.html" target="_blank"> <img src="${pageContext.request.contextPath}/images/65537.png" alt="Tony" width="200" height="200" /> </a> 
                                        </div> 
                                        <div class="bg"></div> 
                                        <div class="name"> 
                                            <span class="man">Tony</span> 
                                        </div> <p class="add"><span>福建 • 厦门，95后</span></p> 
                                        <div class="service"> 
                                            <span>伴游向导</span> 
                                            <span>陪同翻译</span> 
                                            <span>跟拍摄像</span> 
                                    ...
                                    <li class="J_blocklink"> 
                                        <div class="pic"> 
                                            <a href="/daoyou/65581.html" target="_blank"> <img src="${pageContext.request.contextPath}/images/65581.jpg" alt="乔蕊" width="200" height="200" /> </a> 
                                        </div> 
                                        <div class="bg"></div> 
                                        <div class="name"> 
                                            <span class="woman">乔蕊</span> 
                                        </div> <p class="add"><span>北京，70后</span></p> 
                                        <div class="service"> 
                                            <span>伴游向导</span> 
                                            <span>行程规划</span> 
                                            <span>代订服务</span> 
                                    ...
                                    <li class="J_blocklink"> 
                                        <div class="pic"> 
                                            <a href="/daoyou/65548.html" target="_blank"> <img src="${pageContext.request.contextPath}/images/65548.jpg" alt="陈艳" width="200" height="200" /> </a> 
                                        </div> 
                                        <div class="bg"></div> 
                                        <div class="name"> 
                                            <span class="woman">陈艳</span> 
                                        </div> <p class="add"><span>福建 • 厦门，90后</span></p> 
                                        <div class="service"> 
                                            <span>伴游向导</span> 
                                            <span>行程规划</span> 
                                            <span>陪同翻译</span> 
                                    ...
                                    <li class="J_blocklink"> 
                                        <div class="pic"> 
                                            <a href="/daoyou/1.html" target="_blank"> <img src="${pageContext.request.contextPath}/images/1.png" alt="你是白痴吗" width="200" height="200" /> </a> 
                                        </div> 
                                        <div class="bg"></div> 
                                        <div class="name"> 
                                            <span class="woman">你是白痴吗</span> 
                                        </div> <p class="add"><span>台湾 • 台北，90后</span></p> 
                                        <div class="service"> 
                                            <span>伴游向导</span> 
                                            <span>行程规划</span> 
                                            <span>跟拍摄像</span> 
                                        ...
                                        <div class="price"> 
                                            <span class="unit">￥<span>180.00</span>元/天</span> (含车) 
                                        </div> 
                                        <div class="ft"> 
                                            <p> <span class="praise">好评率：94%</span> <span class="order">预约量：4</span> <span class="nice">颜值：100</span> </p> 
                                        </div> </li> 
                                    <li class="J_blocklink"> 
                                        <div class="pic"> 
                                            <a href="/daoyou/3.html" target="_blank"> <img src="${pageContext.request.contextPath}/images/3.jpg" alt="楠楠" width="200" height="200" /> </a> 
                                        </div> 
                                        <div class="bg"></div> 
                                        <div class="name"> 
                                            <span class="woman">楠楠</span> 
                                        </div> <p class="add"><span>香港，70后</span></p> 
                                        <div class="service"> 
                                            <span>伴游向导</span> 
                                            <span>行程规划</span> 
                                            <span>陪同翻译</span> 
                                        ...
                                        <div class="price"> 
                                            <span class="unit">￥<span>680.00</span>元/天</span> (含车) 
                                        </div> 
                                        <div class="ft"> 
                                            <p> <span class="praise">好评率：0%</span> <span class="order">预约量：0</span> <span class="nice">颜值：0</span> </p> 
                                        </div> </li> 
                        ...
                        <div class="module mod-destination"> 
                            ...
                            <div class="bd"> 
                                <ul> 
                                    <li class="J_blocklink"> 
                                        <div class="pic"> 
                                            <a href="/daoyou/beijing/" target="_blank"><img src="${pageContext.request.contextPath}/images/201507270954153441.jpg" alt="北京导游" /></a> 
                                        </div> 
                                        <div class="text"> 
                                            <div class="cover"></div> 
                                            <p> <span class="title">北京</span> <span class="english">Bei Jing</span> </p> 
                                        </div> </li> 
                                    <li class="J_blocklink"> 
                                        <div class="pic"> 
                                            <a href="/daoyou/shijiazhuang/" target="_blank"><img src="${pageContext.request.contextPath}/images/201507271000421573.jpg" alt="石家庄导游" /></a> 
                                        </div> 
                                        <div class="text"> 
                                            <div class="cover"></div> 
                                            <p> <span class="title">石家庄</span> <span class="english">Shi Jia Zhuang</span> </p> 
                                        </div> </li> 
                                    <li class="J_blocklink"> 
                                        <div class="pic"> 
                                            <a href="/daoyou/dalian/" target="_blank"><img src="${pageContext.request.contextPath}/images/201507271000555175.jpg" alt="大连导游" /></a> 
                                        </div> 
                                        <div class="text"> 
                                            <div class="cover"></div> 
                                            <p> <span class="title">大连</span> <span class="english">Da Lian</span> </p> 
                                        </div> </li> 
                                    <li class="J_blocklink"> 
                                        <div class="pic"> 
                                            <a href="/daoyou/xiamen/" target="_blank"><img src="${pageContext.request.contextPath}/images/201507271001089161.jpg" alt="厦门导游" /></a> 
                                        </div> 
                                        <div class="text"> 
                                            <div class="cover"></div> 
                                            <p> <span class="title">厦门</span> <span class="english">Xia Men</span> </p> 
                                        </div> </li> 
                                    <li class="J_blocklink"> 
                                        <div class="pic"> 
                                            <a href="/daoyou/qingdao/" target="_blank"><img src="${pageContext.request.contextPath}/images/201507271002086732.jpg" alt="青岛导游" /></a> 
                                        </div> 
                                        <div class="text"> 
                                            <div class="cover"></div> 
                                            <p> <span class="title">青岛</span> <span class="english">Qing Dao</span> </p> 
                                        </div> </li> 
                                    <li class="J_blocklink"> 
                                        <div class="pic"> 
                                            <a href="/daoyou/taian/" target="_blank"><img src="${pageContext.request.contextPath}/images/201507271001538016.jpg" alt="泰安导游" /></a> 
                                        </div> 
                                        <div class="text"> 
                                            <div class="cover"></div> 
                                            <p> <span class="title">泰安</span> <span class="english">Tai An</span> </p> 
                                        </div> </li> 
                                </ul> 
                                <div class="location"> 
                                    <dl class="item"> 
                                        ...
                                        <dd class="J_blocklink"> 
                                            <a href="/daoyou/xiamen/" target="_blank">厦门</a> 
                                            <span>Xia Men</span> 
                                        </dd> 
                                        <dd class="J_blocklink"> 
                                            <a href="/daoyou/qingdao/" target="_blank">青岛</a> 
                                            <span>Qing Dao</span> 
                                        </dd> 
                                        <dd class="J_blocklink"> 
                                            <a href="/daoyou/taian/" target="_blank">泰安</a> 
                                            <span>Tai An</span> 
                                        </dd> 
                                    </dl> 
                                    <dl class="item"> 
                                        ...
                                        <dd class="J_blocklink"> 
                                            <a href="/daoyou/guilin/" target="_blank">桂林</a> 
                                            <span>Gui Lin</span> 
                                        </dd> 
                                    </dl> 
                                    <dl class="item"> 
                                        ...
                                        <dd class="J_blocklink"> 
                                            <a href="/daoyou/wuhan/" target="_blank">武汉</a> 
                                            <span>Wu Han</span> 
                                        </dd> 
                                        <dd class="J_blocklink"> 
                                            <a href="/daoyou/zhangjiajie/" target="_blank">张家界</a> 
                                    ...
                                    <dl class="item"> 
                                        ...
                                        <dd class="J_blocklink"> 
                                            <a href="/daoyou/beijing/" target="_blank">北京</a> 
                                            <span>Bei Jing</span> 
                                        </dd> 
                                        <dd class="J_blocklink"> 
                                            <a href="/daoyou/shijiazhuang/" target="_blank">石家庄</a> 
                                    ...
                                    <dl class="item"> 
                                        ...
                                        <dd class="J_blocklink"> 
                                            <a href="/daoyou/chengdu/" target="_blank">成都</a> 
                                            <span>Cheng Du</span> 
                                        </dd> 
                                        <dd class="J_blocklink"> 
                                            <a href="/daoyou/lijiang/" target="_blank">丽江</a> 
                                            <span>Li Jiang</span> 
                                        </dd> 
                                        <dd class="J_blocklink"> 
                                            <a href="/daoyou/xianggelila/" target="_blank">香格里拉</a> 
                                    ...
                                    <dl class="item"> 
                                        ...
                                        <dd class="J_blocklink"> 
                                            <a href="/daoyou/xianggang/" target="_blank">香港</a> 
                                            <span>Hong Kong</span> 
                                        </dd> 
                                        <dd class="J_blocklink"> 
                                            <a href="/daoyou/aomen/" target="_blank">澳门</a> 
                                            <span>Macau</span> 
                                        </dd> 
                                    </dl> 
                                </div> 
